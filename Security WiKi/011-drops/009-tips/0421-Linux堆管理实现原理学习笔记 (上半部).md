...
![p1](http://drops.javaweb.org/uploads/images/68f36674575bdb2d5060cb410719188a76f0bff3.jpg)图1-1 函数调用关系图

系统内存分布图：

![p2](http://drops.javaweb.org/uploads/images/6c5f04725b3e24d2d311a5b0fef0dc6fad3e3791.jpg)图1-2系统内存分布图
...
![p3](http://drops.javaweb.org/uploads/images/40d1361fd8880773b11792a3f606cb69b16f6fd8.jpg)
...
![p4](http://drops.javaweb.org/uploads/images/d2da88fe7c17eede2d25d7392dea05a89cb5aafb.jpg)

**4. Before malloc in thread1:**

在thread1调用malloc之前：从输出结果可以看出thread1中并没有heap segment，但是此时thread1自己的栈空间已经分配完毕了：

![p5](http://drops.javaweb.org/uploads/images/6d18ad387a98c4e29da64d1ee3a0fea9ba9a937b.jpg)
...
![p6](http://drops.javaweb.org/uploads/images/12c0fff4f7d82ec897e73260eaf2e4a7aa299218.jpg)
...
![p7](http://drops.javaweb.org/uploads/images/bb80daafd17f22ae668bb17e182f3aba3203b148.jpg)图4-1 只含一个heap segment的main arena与thread arena图

下图是一个thread arena中含有多个heap segments的情况：

![p8](http://drops.javaweb.org/uploads/images/dde2083630446d36d0a7c7c686a65adad4e56bfb.jpg)图4-1 一个thread arena含有多个heap segments的内存分布图
...
![p9](http://drops.javaweb.org/uploads/images/d1def9671a1021ba17a1afbaa0b25f05e712a914.jpg)图5-1 简单的allocated chunk格式

![p10](http://drops.javaweb.org/uploads/images/2503907a8026149917b699f27a003057582165df.jpg)图5-2 简单的free chunk格式
...
![p11](http://drops.javaweb.org/uploads/images/961e0b65ca39d0f83345009842b6c3dbaba43c0e.jpg)图5-3 简单的chunk序列
...
![p12](http://drops.javaweb.org/uploads/images/aeb20e92f6380bc0b93862c21d503f999ae0e3cd.jpg)图5-4 改进版的chunk格式之Knuth边界标记
...
![p13](http://drops.javaweb.org/uploads/images/d88531ceaa1bdb2afb38268ff5c2e030709711f1.jpg)图5-5 改进版的Knuth边界标记allocated chunk格式

![p14](http://drops.javaweb.org/uploads/images/417b7f217b5fe71c4ba4b09682de4e8943dea654.jpg)图5-6 改进版的Knuth边界标记free chunk格式
...
首先思考：是否有必要同时保存当前chunk和前一个chunk的已分配/空闲标记位？答案是否定的，因为我们只需要保存**前一个chunk**的分配标志位就可以了，至于**当前chunk**的分配标志位，可以通过查询**下一个chunk**的size字段得到。那么size字段中剩下的两个比特位就可以用于满足多线程的标志需求了：

![p15](http://drops.javaweb.org/uploads/images/6960b27df61a23a882415880cb0b8f179c5ffb09.jpg)图5-7 多线程版本Knuth边界标记allocated chunk格式

![p16](http://drops.javaweb.org/uploads/images/b89c31d573109955c1dd99a761de3215e879727c.jpg)图5-8 多线程版本Knuth边界标记free chunk格式
...
![p17](http://drops.javaweb.org/uploads/images/3370547babacbe9a18803fe0fa99057f20f44de7.jpg)图5-9 当前glibc malloc allocated chunk格式

![p18](http://drops.javaweb.org/uploads/images/98f8051465dc1a85b8ad3bda5b556da7e2b49b77.jpg)图5-10 当前glibc malloc free chunk格式
