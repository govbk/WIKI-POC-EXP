...
用python2执行：`python exp.py www.baidu.com 8080 100`：

![1.png](images/2020_06_13/ad876bfea612431bafbe7a5098f47936.png)

可见，执行到第289个数据包的时候就写入成功。然后，利用lfi.php，即可执行任意命令：

![2.png](images/2020_06_13/fae7a137eb4a47c3aa76b81fe382f884.png)
